...
export const TestSelector = (props: TestSelectorProps) => {
  ...
  return (
    <div className="flex items-center justify-center gap-2 mt-2 mb-4">
      {/* Button */}
      <DropdownContainer
        itemOptions={AlgoTestEnumsList}
        selectedItem={selectedTestEnum}
        setSelectedItem={setSelectedTestEnum}
      />
      ...
      <Button
        onClick={() => {
          const prev = selectedTest;
          setSelectedTest({ obstacles: [] });
          setSelectedTest(AlgoTestEnumMapper[selectedTestEnum]);
        }}
      >
        Reset grid
      </Button>
...
const TestItem = (props: TestItemProps) => {
  ...
  return (
    <div
      className="flex items-center justify-center gap-2 cursor-pointer group/test"
      onClick={() => {
